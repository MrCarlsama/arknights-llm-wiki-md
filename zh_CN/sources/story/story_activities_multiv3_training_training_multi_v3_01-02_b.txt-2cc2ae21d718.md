---
kind: "evidence"
title: "剧情脚本 / activities/multiv3/training/training_multi_v3_01-02_b"
text_complete: true
---

# 剧情脚本 / activities/multiv3/training/training_multi_v3_01-02_b

## 链接的 Wiki 页面

- [阵地屏障 (unit)](../../units/阵地屏障-52220ece9c.md)
...
protectTime=0.5, dialogHead="$avatar_amiya", dialogX="$f_lower_dialog_pos_x", dialogY="$f_lower_dialog_pos_y")] \
这只可爱的小鼷兽是敌方的击球手，它会试图追上足球，并向我方射门！
[Tutorial(focusX=-480, focusY=40, focusWidth=200, focusHeight=200, \
animStyle="Highlight", focusStyle="HighlightCircle", black=0.5, \
protectTime=0.5, dialogHead="$avatar_amiya", dialogX="$f_lower_dialog_pos_x", dialogY="$f_lower_dialog_pos_y")] \
这时就需要部署干员防守球门。这些带有特殊标记的地块是守门位，部署在上面的干员会承担起守门员的职责。
守门员不仅不占用部署人数，可以接住飞来的足球。
