---
kind: "evidence"
title: "资料页 / character_table / char_1020_reed2"
text_complete: true
---

# 资料页 / character_table / char_1020_reed2

## 链接的 Wiki 页面

- [苇草 (character)](../../characters/苇草-9868d2c645.md)
- [焰影苇草 (character)](../../characters/焰影苇草-9860acf32f.md)
...
```text
{
 ...
 "overrideDescripton": "攻击造成法术伤害，攻击敌人时为攻击范围内一名友方干员治疗相当于{scale:0%}伤害的生命值",
 "prefabKey": null,
 "rangeId": null
 }
 ]
 ...
 "prefabKey": "1",
 "name": "灼痕",
 "description": "造成伤害时有30%概率对敌人施加灼痕效果：攻击力-12%（+2）、17%（+2）的<$ba.magicfragile>【法术脆弱】，不可叠加持续6秒",
 "rangeId": null,
 "blackboard": [
 {
 "key": "prob",
 ...
 "prefabKey": "1",
 "name": "灼痕",
 "description": "造成伤害时有30%概率对敌人施加灼痕效果：攻击力-22%（+2）、32%（+2）的<$ba.magicfragile>【法术脆弱】，不可叠加持续6秒",
 "rangeId": null,
 "blackboard": [
 {
 "key": "prob",
 ...
 "prefabKey": "2",
 "name": "映耀",
 "description": "治疗其他友方单位时，焰影苇草同时享受55%（+5）的治疗量",
 "rangeId": null,
 "blackboard": [
 {
 "key": "scale",
