---
kind: "evidence"
title: "剧情脚本 / activities/act2vmulti/training/fortress/training_fortress_a3"
text_complete: true
---

# 剧情脚本 / activities/act2vmulti/training/fortress/training_fortress_a3

## 链接的 Wiki 页面

- [折叠式堡垒模块 (unit)](../../units/折叠式堡垒模块-ffe2a52198.md)
- [折叠式后勤站 (unit)](../../units/折叠式后勤站-4a112573b1.md)
- [折叠式维护车 (unit)](../../units/折叠式维护车-b7178223ee.md)
...
折叠设施维护员工作一段时间后会下班，折叠设施需要经过三次维护才能投入使用。
不过如果地形合适，也可以派遣多名维护员同时维护。
...
向折叠式维护车的方向部署维护员！
一切顺利，维护车应该可以投入使用了！
如果操作失误，没有让维护员正确地朝向需要维护的设施，维护员会自主返回待部署区，等待下一次派遣。
场上目前还没有高台位，我们该怎么上场？
抵御住下一波进攻，再次进入休整阶段时，赛场维护车就会为我们带来更多折叠设施维护员。
到时候就可以派遣他们去维护【折叠式堡垒模块】，展开成为可部署高台干员的【堡垒筑台】，为更多干员创造上场的机会。
