---
kind: "evidence"
title: "资料页 / character_table / char_2023_ling"
text_complete: true
---

# 资料页 / character_table / char_2023_ling

## 链接的 Wiki 页面

- [令 (character)](../../characters/令-94875671fb.md)
...
```text
{
 ...
 "prefabKey": "2",
 "name": "随付笺咏醉屠苏",
 "description": "召唤物被击倒/吸收/回收时令额外获得3(+1)点技力、攻击力+2%（攻击力加成最多叠加5层）",
 "rangeId": null,
 "blackboard": [
 {
 "key": "max_stack_cnt",
 ...
 "prefabKey": "2",
 "name": "随付笺咏醉屠苏",
 "description": "召唤物被击倒/吸收/回收时令额外获得4(+1)点技力、攻击力+3%（攻击力加成最多叠加5层）",
 "rangeId": null,
 "blackboard": [
 {
 "key": "max_stack_cnt",
