---
kind: "evidence"
title: "资料页 / handbook_info_table / handbookDict.char_449_glider"
text_complete: true
---

# 资料页 / handbook_info_table / handbookDict.char_449_glider

## 链接的 Wiki 页面

- [薄绿 (character)](../../characters/薄绿-47cb282aec.md)
...
- [苦涩的根茎 (event)](../../events/苦涩的根茎-f2faa31d61.md)
...
```text
{
 ...
 "stories": [
 {
 "storyText": "雷姆必拓出身的草药医生，兼修心理学。罗德岛医疗部成员。在利用丰富的草药学知识对抗生理疾病的同时，也在努力维护各位干员的心理健康。",
 "unLockType": "DIRECT",
 "unLockParam": "",
 "showType": "DIRECT",
 "showParam": "",
 ...
 "handbookAvgList": [
 {
 "storySetId": "story_glider_set_1",
 "storySetName": "苦涩的根茎",
 "sortId": 1,
 "storyGetTime": 1665475200,
 "rewardItem": [],
 "unlockParam": [
 {
 "unlockType": "AWAKE",
 ...
 "avgList": [
 {
 "storyId": "story_glider_set_1_story_1",
 "storySetId": "story_glider_set_1",
 "storySort": 1,
 "storyCanShow": true,
 "storyIntro": "偏见与隔阂看似不可撼动，但总得有人，也总会有人做些什么。",
 "storyInfo": "info/obt/memory/story_glider_1_1",
 "storyTxt": "obt/memory/story_glider_1_1"
 }
 ],
 "charId": "char_449_glider"
 }
