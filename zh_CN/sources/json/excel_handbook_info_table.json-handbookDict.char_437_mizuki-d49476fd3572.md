---
kind: "evidence"
title: "资料页 / handbook_info_table / handbookDict.char_437_mizuki"
text_complete: true
---

# 资料页 / handbook_info_table / handbookDict.char_437_mizuki
...
- [第五类接触 (event)](../../events/第五类接触-a8a27dc8cc.md)
...
```text
{
 ...
 "stories": [
 {
 "storyText": "水月于玻利瓦尔的多索雷斯城与我们的部分干员有所接触，并随行至本舰，经相关干员初步问询考察后批准其暂时留舰。\n其学习能力较为优秀，现阶段已经能协助完成相当一部分的文职工作内容，或可考虑往干员的方向培养。经调查与评估后批准其长期留舰。",
 "unLockType": "DIRECT",
 "unLockParam": "",
 "showType": "DIRECT",
 "showParam": "",
 ...
 "stories": [
 {
 "storyText": "造影检测结果显示，该对象体内脏器轮廓清晰，未见异常阴影，循环系统内源石颗粒检测未见异常，无矿石病感染迹象，现阶段可确认为非矿石病感染者。\n\n【体细胞与源石融合率】0%\n该对象没有被源石感染的迹象。\n\n【血液源石结晶密度】0.07u/L\n该对象甚少接触源石。\n\n\n警告，权限不足。部分详细生理参数需要更高的医疗部门相关权限进行访问。",
 "unLockType": "FAVOR",
 "unLockParam": "25",
 "showType": "DIRECT",
 "showParam": "",
 ...
 "avgList": [
 {
 "storyId": "story_mizuki_set_1_story_1",
 "storySetId": "story_mizuki_set_1",
 "storySort": 1,
 "storyCanShow": true,
 "storyIntro": "事在人为，你是否已经准备好承担因你与他而起的所有责任与后果。",
 "storyInfo": "info/obt/memory/story_mizuki_1_1",
 "storyTxt": "obt/memory/story_mizuki_1_1"
 }
 ],
 "charId": "char_437_mizuki"
 }
