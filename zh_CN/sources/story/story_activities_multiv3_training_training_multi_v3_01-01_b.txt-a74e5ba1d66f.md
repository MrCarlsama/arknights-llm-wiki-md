---
kind: "evidence"
title: "剧情脚本 / activities/multiv3/training/training_multi_v3_01-01_b"
text_complete: true
---

# 剧情脚本 / activities/multiv3/training/training_multi_v3_01-01_b
...
```text
联机教学关1b
与之前一样，每场比赛分为两个阶段，每个阶段都有需要完成的目标。
...
本场比赛第一阶段的目标是生存，我们需要在限定时间内抵挡敌方的进攻。
虽然在同一片赛场上竞技，但我们各自需要防守不同的目标点。
